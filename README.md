...
- Added experimental saving/loading system, its code can be found on the "saving" branch, the implementation is not perfect, but maybe someone will find it useful
